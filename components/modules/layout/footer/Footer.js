                ...
                <div className="md:flex gap-x-5 gap-y-10 md:gap-10">
                    <div className="flex gap-5 mb-5 md:mb-0">
                        ...
                        <div className="flex flex-col gap-5 justify-start">
                            ...
                            <Link href="/pages/contact-us" className="text-[#4A4A4A] hover:text-cyan">تماس با ما</Link>
                            <Link href="/pages/submitting-complaint" className="text-[#4A4A4A] hover:text-cyan">ثبت
                                شکایت</Link>
