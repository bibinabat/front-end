    ...
    return (
        <div className="">
            ...
            <div className="py-5 px-3 font-[600] text-blue-dark">
                ...
                <Link href="/pages/contact-us" className="block bg-white px-3 py-2 rounded-lg mb-2"
                      onClick={toggleSidebar(false)}>
                    تماس با ما
                </Link>
                <Link href="/pages/about-us" className="block bg-white px-3 py-2 rounded-lg mb-2"
                      onClick={toggleSidebar(false)}>
                    درباره ما
                </Link>
            </div>
