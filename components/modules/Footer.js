        ...
        <footer className="mt-10 relative mb-20 lg:mb-0">
            <div className="relative">
                <Tooltip arrow title="بازگشت به بالا">
                    <button onClick={handleScrollToTop} className="z-20 absolute bg-blue-dark w-10 h-10 flex items-center justify-center rounded-full right-1/2 translate-x-1/2 shadow-[0px_23px_55px_-6px_rgba(0,0,0,0.5)] -top-5">
                        <Image src="/customIcons/NavIcon.svg" alt="nav icon" width={10} height={10} className="-rotate-90"/>
                    </button>
                </Tooltip>
                        ...
                        <div className="flex items-center flex-col justify-center lg:ml-10">
                            <div className="grid grid-cols-2 grid-rows-2 gap-x-20 md:flex md:gap-20">
                                <div className="flex flex-col items-center gap-9">
                                    <Image src="/images/footerImages/24-7Support.png" alt="warranty" width={55} height={100} className="w-auto"/>
                                    <span className="text-[#4E4E4E] text-center">پشتیبانی 24/7</span>
                                </div>
                                <div className="flex flex-col items-center gap-5">
                                    <Image src="/images/footerImages/Gift.png" alt="gift" width={45} height={100} className="w-auto"/>
                                    <span className="text-[#4E4E4E]">هدیه خرید</span>
                                </div>
                                <div className="flex flex-col items-center gap-5">
                                    <Image src="/images/footerImages/FastDelivery.png" alt="fast delivery" width={55} height={100} className="w-auto"/>
                                    <span className="text-[#4E4E4E]">ارسال سریع</span>
                                </div>
                                <div className="flex flex-col items-center gap-5">
                                    <Image src="/images/footerImages/Warranty.png" alt="warranty" width={45} height={100} className="w-auto"/>
            ...
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-0 items-center lg:items-start justify-between mt-10 px-5 md:px-20">
                <div className="grid grid-cols-2 grid-rows-2 md:flex gap-x-5 gap-y-10 md:gap-10">
                    <div className="flex flex-col gap-5 justify-start">
                        <p className="font-bold mb-1 text-lg">پر فروش ترین محصولات</p>
                        <Link href="/" className="text-[#4A4A4A] hover:text-cyan">خرید پرده نبات زعفرانی اعلا</Link>
                        <Link href="/" className="text-[#4A4A4A] hover:text-cyan">خرید پرده نبات اعلا</Link>
                        <Link href="/" className="text-[#4A4A4A] hover:text-cyan">خرید کاسه نبات زعفرانی اعلا</Link>
                        <Link href="/" className="text-[#4A4A4A] hover:text-cyan">خرید کاسه نبات اعلا</Link>
                    </div>
                    <div className="flex flex-col gap-5 justify-start">
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div>
                        <form onSubmit={handleSubmit(handleFooterFormSubmit)} className="h-full flex">
                            ...
                            />
                            <button className="bg-blue-dark text-white font-bold h-10 px-8 rounded-lg mr-2 hover:bg-[#30287A] transition">ثبت</button>
                        </form>
                    </div>
                    ...
                    <div className="w-full flex gap-10 text-[#C4C4C4] text-3xl">
                        ...
                        <Link href="https://www.linkedin.com/shareArticle?mini=true&url=https://bibinabat.com/" target="_blank">
            ...
            <div className="flex flex-col gap-5 lg:gap-0 lg:flex-row items-center justify-between mt-10 px-5 md:px-20">
                <div>
                    ...
                    <p className="max-w-xl leading-10 font-[500] text-blue-dark">
                        ...
                        از عرضه کنندگان مطرح نبات در کشور به شمار آمده و انواع نبات اصل و درجه یک یزدی را خدمت شما خریداران عزیز ارائه خواهد کرد. این مجموعه، محصولات با کیفیت را گلچین کرده تا شما بتوانید با خرید آنها، رضایت کافی را به دست آورده و در آخر، نبات های یزدی اصیل را نصیب خود کنید ، چنانچه قصد
            ...
            <div className="overflow-hidden h-full absolute bottom-0 -z-10 w-full">
                <Image src="/images/footerImages/yazd.png" alt="Yazd" width={1000} height={1000} className="absolute left-[600px] scale-[7] bottom-72 lg:left-0 lg:scale-100 lg:bottom-0 lg:w-full opacity-5"/>
            </div>
        </footer>
    );
};
